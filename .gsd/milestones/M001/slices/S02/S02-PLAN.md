...
- [x] **T02: Implement core transformer — milestone detection, phase-to-slice mapping, task mapping** `est:1h`
...
- [x] **T03: Implement research consolidation, requirements mapping, field defaulting, and pass all tests** `est:45m`
